<template>
    <div>
        ...
        <div style="margin: 10px 0">
            ...
            <el-input style="width: 200px; margin-left: 5px" placeholder="请输入地址" suffix-icon="el-icon-s-promotion" v-model="address"></el-input>
...
export default {
  ...
  methods: {
    ...
    delBatch() {
      ...
      fetch("http://localhost:9090/user/del/batch", {
          method: 'POST',
