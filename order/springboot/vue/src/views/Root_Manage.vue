<template>
    <div>
        ...
        <div style="margin: 10px 0">
            ...
            <el-input style="width: 200px; margin-left: 5px" placeholder="请输入电话号码" suffix-icon="el-icon-phone" v-model="phone"></el-input>
...
<script>
    export default {
        ...
        methods: {
            //请求分页查询用户信息
            load() {
                fetch("http://localhost:9090/root/page?pageNum=" + this.pageNum + "&pageSize=" + this.pageSize +
            ...
            //删除数据
            del(id) {
                fetch("http://localhost:9090/root/" + id, {
                    method:'Delete',
                    headers: {
            ...
            delBatch() {
                ...
                fetch("http://localhost:9090/root/del/batch", {
                    method: 'POST',
            ...
            //确认提交
            save() {
                fetch("http://localhost:9090/root",{
                    method: 'POST',
